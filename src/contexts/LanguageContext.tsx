...
const dateConfig: Record<Language, { locale: string; options: Intl.DateTimeFormatOptions }> = {
...
export const LanguageProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    document.documentElement.dir = 'ltr'; // Hiện tại chưa hỗ trợ RTL
    
    // Update page title based on language
    const titles: Record<Language, string> = {
      en: 'Yapee - Premium Shopping & Quality Service',
  ...
  const t = (key: string, params?: Record<string, string | number>): string => {
    ...
    let translation = translationsForLanguage[key] || fallbackTranslations[key] || key;
